...
* dash.conf: contains configuration settings for vkaxd or vkax-qt
* vkaxd.pid: stores the process id of vkaxd while running
...
* debug.log: contains debug information and general logging generated by vkaxd or vkax-qt

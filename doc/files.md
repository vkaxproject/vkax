...
* dash.conf: contains configuration settings for jgcd or jgc-qt
* jgcd.pid: stores the process id of jgcd while running
...
* debug.log: contains debug information and general logging generated by jgcd or jgc-qt

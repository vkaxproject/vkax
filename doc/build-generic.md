...
---------------------
Vkax inherited the `depends` folder from Bitcoin, which contains all dependencies required to build Vkax. These
...
ccache
------
`./configure` of Vkax Core will autodetect the presence of ccache and enable use of it. To disable ccache, use

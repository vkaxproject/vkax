...
public:
    ...
    using NotifyBlockLockFn =
    std::function<void(const std::string& bestBlockLockedHash, int32_t bestBlockLockedHeight)>;
    virtual std::unique_ptr<Handler> handleNotifyBlockLock(NotifyBlockLockFn fn) = 0;

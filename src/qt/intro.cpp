    ...
    signalled(false)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Vkax block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory(interfaces::Node& node)
{
     ...
     * override -datadir in the vkax.conf file in the default data directory
     * (to be consistent with vkaxd behavior)
     */

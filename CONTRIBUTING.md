Contributing to Jagoan Core
============================

The Jagoan Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/jgcproject/jgc/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Jagoan Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Jagoan
Network Protocol consensus changes.

Whether a pull request is merged into Jagoan Core rests with the project merge
...
Patches that change Jagoan consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jagoan consensus, it must have been
...
The review process is normally fairly responsive on the Jagoan Core repository, however
...
The project leader is the release manager for each Jagoan Core release.
